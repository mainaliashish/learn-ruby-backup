...
# connObj = Connection::Service.get/
# database = Connection::Service.new
# res = Connection::Service.request_connection
# puts res
...
# user = database.create_user("gita", "gita@yahoo.com", "gita123")
...
# up_user = database.update_user(6, "ramlama", "ram@lama.com")
# puts up_user

del_user = database.delete_user(27)
puts del_user
# if del_user
#   puts "User deleted"
# end
